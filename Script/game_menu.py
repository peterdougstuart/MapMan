...
class MenuScene (Scene):
	def __init__(self, title, subtitle, button_titles, subtitle_size=20):
		Scene.__init__(self)
		self.title = title
	...
	def setup(self):
		...
		subtitle_font = ('Avenir Next', self.subtitle_size)
		...
		self.subtitle_label = LabelNode(self.subtitle, font=subtitle_font, position=(0, self.menu_bg.size.h/2 - 100), color='black', parent=self.menu_bg)
